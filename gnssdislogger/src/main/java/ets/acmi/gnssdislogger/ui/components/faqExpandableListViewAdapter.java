...
public class faqExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public faqExpandableListViewAdapter(Context context, List<String> listDataGroup,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.faq_row_child, null);
        }

        TextView textViewChild = convertView
                .findViewById(R.id.faq_textViewChild);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.faq_row_title, null);
        }

        TextView textViewGroup = convertView
                .findViewById(R.id.faqTextViewTitle);
