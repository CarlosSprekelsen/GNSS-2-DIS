...
public class Strings {
    ...
    public static String getIsoDateTime(Date dateToFormat) {
        /*
          This function is used in ets.acmi.gnssdislogger.loggers.* and for most of them the
    ...
    private static String getIsoCalendarDateFormat() {
        return "yyyy-MM-dd";
    }
    ...
    private static String getFormattedCustomFileName(String baseName, Calendar calendar, PreferenceHelper ph) {
    ...
    public static Map<String, String> getAvailableLocales(Context context) {
        ...
        for(Locale l:avlocales)
        {
            localcountries.add(l.getDisplayLanguage().toString());
        }
        String[] availableLocales=(String[]) localcountries.toArray(new String[localcountries.size()]);
    ...
    private static String getDegreesMinutesSeconds(double decimaldegrees, boolean isLatitude) {
    ...
    private static String getDegreesDecimalMinutes(double decimaldegrees, boolean isLatitude) {
        String cardinality = (decimaldegrees < 0) ? "S" : "N";
    ...
    private static String getDecimalDegrees(double decimaldegrees) {
